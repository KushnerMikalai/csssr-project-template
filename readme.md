...
Все дополнительные библиотеки js устанавливаются через npm или yarn и добовляются в файле app/scripts/libs.js 
...
```
git clone git@github.com:KushnerMikalai/csssr-project-template.git new-project && cd new-project
```
...
│       ├── libs.styl          # Подключение стилевых файлов библиотек
